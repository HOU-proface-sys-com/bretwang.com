...
var b=a.is(":visible");1==a.data("no-hover")&&(b=!0);b?a.hide():a.show();setTimeout(function(){e.locktaps=!1},250)}}));pdfemb_trans.poweredby&&d.append(g("<div></div>",{"class":"pdfemb-poweredby"}).append(g('<a></a>')))};d.prototype.magnifyEvent=function(a){var c=a.originalEvent.magnification;if(-1==c)this.resizeViewer(),this.resizeInnerDivs(),this.invalidateAllPages(),this.renderPage(this.getTopVisiblePageNum());
