...
　　　if(jQuery(this).attr("href").indexOf("github.com/ihavealonglongname") > 0 || jQuery(this).attr("href").indexOf("www.npmjs.com/~bretwang") > 0 || jQuery(this).attr("href").indexOf("hub.docker.com/r/bretwang/") > 0){
